  ...
  return (
    <div className="space-y-4">
      <div className="flex gap-3 items-end">
        ...
        <label className={`flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-full cursor-pointer transition-colors ${
          uploading ? 'bg-secondary text-muted-foreground cursor-not-allowed' : 'bg-primary text-primary-foreground hover:bg-primary/90'
        }`}>
